...
exports.seed = async function(knex) {
  ...
  await knex('leagues').insert([
    ...
    {id: 5, league_Id: '1', League_Id_TheSportsDB: '4429', league_name:"World Cup", league_logo:"https://upload.wikimedia.org/wikipedia/en/thumb/7/7a/2015_FIFA_Club_World_Cup.svg/800px-2015_FIFA_Club_World_Cup.svg.png"},
